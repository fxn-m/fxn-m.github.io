...
import { SPOTIFY_CURRENT_TRACK_ENDPOINT, SPOTIFY_TOKEN_ENDPOINT } from "../config/constants";
...
export async function getSpotifyAccessToken(config: AppConfig): Promise<string> {
